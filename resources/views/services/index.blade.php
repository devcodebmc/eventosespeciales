                            ...
                            @foreach ($services as $service)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <!-- Modal -->
                                        <div id="confirmationModal{{ $service->id }}" class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center z-50 transition-opacity duration-300 hidden">
