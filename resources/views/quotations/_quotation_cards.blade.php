            ...
            <div class="flex items-end justify-between">
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <button type="button"
                            ...
                            class="quotation-edit inline-flex items-center justify-center w-8 h-8 rounded-lg bg-[var(--cz-brass-soft)] text-[var(--cz-brass-deep)] hover:bg-[var(--cz-brass)] hover:text-white border border-[var(--cz-brass)]/20 hover:border-[var(--cz-brass)] transition-all duration-200">
                    ...
                    <button type="button"
                            ...
                            class="quotation-delete inline-flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 text-gray-400 hover:bg-red-500 hover:text-white border border-gray-200/50 hover:border-red-500 transition-all duration-200">
