...
<head>
    ...
    <title>Gracias por contactarnos | Eventos Especiales Lerma</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Es un placer recibir tu mensaje. Hemos registrado tu consulta y nuestro equipo especializado se pondrá en contacto contigo antes de 24 horas para ofrecerte una respuesta detallada.</p>
            
            <div class="details">
                <p style="font-weight: 600; color: #F6BBA9; margin-bottom: 20px; font-size: 14px; letter-spacing: 0.5px; text-transform: uppercase;">Detalles de tu mensaje</p>
                
                <div class="detail-item">
                    <span class="detail-label">Asunto</span>
                    <span class="detail-value">{{ $contactData['subject'] ?? 'Consulta general' }}</span>
                </div>
                
                <div class="detail-item">
                    <span class="detail-label">Mensaje</span>
                    <span class="detail-value">{{ $contactData['message'] }}</span>
                </div>
                
                <div class="detail-item">
                    <span class="detail-label">Fecha de envío</span>
                    <span class="detail-value">{{ now()->format('d/m/Y \a \l\a\s H:i') }}</span>
                </div>
            </div>
            
            <p>Para cualquier urgencia o información adicional, puedes responder directamente a este correo o contactarnos a través de los siguientes medios:</p>
