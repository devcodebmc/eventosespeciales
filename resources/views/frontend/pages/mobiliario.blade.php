...
@section('title', 'Mobiliario - Eventos Especiales Lerma')
...
@section('ogurl', 'https://eventosespecialeslerma.com/mobiliario')
@section('ogimage', asset('images/logo-white.png'))
@section('ogimage:secure_url', asset('images/logo-white.png'))

@section('twittertitle', 'Mobiliario - Eventos Especiales Lerma')
@section('twitterdescription', 'Descubre nuestro mobiliario exclusivo para eventos en Eventos Especiales Lerma. Ofrecemos una amplia gama de muebles y decoraciones para bodas, fiestas y eventos corporativos. Personaliza tu celebración con estilo y elegancia.')
