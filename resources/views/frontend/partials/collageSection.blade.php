<section class="relative flex justify-center items-center my-12 md:my-20">
    <div class="w-full max-w-5xl mx-auto relative">
        ...
        <div class="relative flex justify-center gap-2 md:gap-4 lg:gap-6 items-end z-10" data-animate-scale>
            <!-- Left image -->
            <div class="relative">
                <img src="{{ asset('images/pla1.jpg') }}" alt="" class="w-28 h-40 md:w-40 md:h-56 lg:w-56 lg:h-80 object-cover object-center rounded-t-full rounded-b-[40px] shadow-2xl opacity-95" />
            </div>
            <!-- Center image -->
            ...
            <!-- Right image -->
            <div class="relative">
                <img src="{{ asset('images/pla2.jpg') }}" alt="" class="w-28 h-40 md:w-40 md:h-56 lg:w-56 lg:h-80 object-cover object-center rounded-t-full rounded-b-[40px] shadow-2xl opacity-95" />
            </div>
        </div>
        ...
        <div class="hidden lg:block pointer-events-none select-none absolute top-0 left-0 w-16 h-16 sm:w-24 sm:h-24 md:w-40 md:h-40 lg:w-64 lg:h-64 opacity-80 z-0" 
             ...
             data-animate-scale>
            <img src="{{ asset('images/hoja-izquierda.svg') }}" alt="" class="w-full h-full" />
        </div>
        ...
        <div class="hidden lg:block pointer-events-none select-none absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 md:w-40 md:h-40 lg:w-64 lg:h-64 opacity-80 z-0 overflow-x-hidden" 
             ...
             data-animate-scale>
            <img src="{{ asset('images/hoja-derecha.svg') }}" alt="" class="w-full h-full" />
        </div>
