            ...
            <section aria-labelledby="contact-heading">
                ...
                <address class="not-italic text-sm sm:text-base space-y-2">
                    ...
                    <p class="text-sm sm:text-base space-y-2">
                        ...
                        <a href="mailto:fincaisabela@eventosespecialeslerma.com" class="inline-flex items-center gap-2 text-sm sm:text-base hover:text-[#4b8b97] transition-colors focus:outline-none focus:ring-2 focus:ring-[#4b8b97] focus:ring-offset-2 focus:ring-offset-gray-100 rounded">
                             <svg class="w-4 h-4 text-[#4b8b97]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                            </svg>
                            fincaisabela@eventosespecialeslerma.com
                        </a>
                    </p>
                </address>
            </section>
