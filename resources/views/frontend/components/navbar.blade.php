<nav class="bg-white shadow-sm">
        ...
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden md:flex md:items-center md:space-x-12">
                ...
                <div class="relative group">
                    ...
                    <!-- Dropdown -->
                    <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform -translate-y-1 group-hover:translate-y-0">
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-white shadow-lg rounded-b-lg">
        <div class="px-4 pt-2 pb-6 space-y-2">
            <a href="#" class="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-[#65ABB7] hover:bg-blue-50 transition">Home</a>
            <a href="#" class="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-[#65ABB7] hover:bg-blue-50 transition">About Us</a>
            <a href="#" class="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-[#65ABB7] hover:bg-blue-50 transition">Services</a>
            <a href="#" class="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-[#65ABB7] hover:bg-blue-50 transition">Portfolio</a>
            <div class="block">
                <button id="mobile-dropdown-toggle" class="w-full flex justify-between items-center px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-[#65ABB7] hover:bg-blue-50 focus:outline-none transition">
                    <span>Pages</span>
            ...
            <a href="mailto:info@eventosespecialeslerma.com" class="flex items-center px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-[#65ABB7] hover:bg-blue-50 transition">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2 text-[#65ABB7]">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                </svg>
                Contact Us
...
@push('js')
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const mobileLinks = document.querySelectorAll('#mobile-menu a:not(#mobile-dropdown a)');
